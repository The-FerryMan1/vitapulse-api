...
export const sendVerificationCode = async (email: string, code: string) => {
    const mailOptions = {
        ...
        text: `Welcome to Vitapulse! Please verify your email by clicking the following link: https://vitapulse-api.onrender.com/verification/${code}`,
        html: `
        <div style="font-family: Arial, sans-serif; color: #333;">
            <h2 style="color: #4CAF50;">Welcome to Vitapulse!</h2>
            <p>Thank you for signing up. Please verify your email address to get started:</p>
            <p>
                <a href="https://vitapulse-api.onrender.com/verification/${code}"
                   style="background-color: #4CAF50; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">
                    Verify Email
                </a>
            </p>
            <p>If the button doesn't work, you can also click or copy the link below into your browser:</p>
            <p><a href="https://vitapulse-api.onrender.com/verification/${code}">https://vitapulse-api.onrender.com/verification/${code}</a></p>
